                          ...
                          GError            **error)
{
  ...
  gboolean         is_mounted;
 //to check if it is a package
  gboolean 	  is_bonzai_package = FALSE;
  ...
  /* checking for directory name if it is .app we have a package here*/
  ...
  while (!exo_job_is_cancelled (EXO_JOB (job)))
    {
      ...
      info = g_file_enumerator_next_file (enumerator,
                                          ...
                                          &err);
      //don't show user unfriendly stuff in the package
